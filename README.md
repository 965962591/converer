...
`aebox_conver.py` 是一个面向日常调试与格式处理的 `RAW / YUV` 转换工具。它支持单文件预览、参数试错、批量转 JPG、RAW 格式互转、YUV 格式互转，以及通过拖拽快速加载文件。

本文档以“实际使用者”的角度编写，重点说明工具能做什么、该怎么用、哪些地方最容易踩坑。截图位置可按你的需要补充。
